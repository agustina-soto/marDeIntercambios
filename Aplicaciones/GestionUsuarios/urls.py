...
urlpatterns = [
    ...
    path('ver_todas_publicaciones/', profile_views.ver_todas_mis_publicaciones, name='ver_todas_mis_publicaciones'),
    path('ver_todas_ofertas/', profile_views.ver_todas_mis_ofertas, name='ver_todas_mis_ofertas'),
]
