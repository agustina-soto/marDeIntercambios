...
urlpatterns = [
    ...
    path('perfil_de_usuario/editar/', profile_views.editar_perfil_view, name='editar_perfil_usuario'),
    path('perfil_de_usuario/actualizar_password/', password_update.actualizar_password, name='actualizar_password'),
    path('perfil_de_usuario/dar_de_baja_cuenta/', desactive_account.dar_de_baja, name='dar_de_baja_cuenta'),
